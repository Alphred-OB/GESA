                        ...
                        <div x-show="resourceType === 'file'" x-cloak class="space-y-4">
                            @if($resource->file_path)
                                <div class="mb-6 flex items-center gap-4 rounded-3xl border border-[#16136a]/10 bg-[#16136a]/5 p-4">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="truncate text-xs font-semibold text-[#16136a]">{{ basename($resource->file_path) }}</p>
                                    </div>
                                    <a href="{{ $resource->download_url }}" target="_blank" class="text-[10px] font-semibold text-[#16136a] uppercase tracking-widest hover:underline">Preview</a>
                                </div>
                            @endif
                            ...
                            <label for="file" class="group flex min-h-[160px] cursor-pointer flex-col items-center justify-center gap-4 rounded-[2.5rem] border-2 border-dashed border-slate-200 bg-slate-50/50 transition-all hover:border-[#16136a]/40 hover:bg-white">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mt-1 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Optional · Max 50MB</p>
                                </div>
