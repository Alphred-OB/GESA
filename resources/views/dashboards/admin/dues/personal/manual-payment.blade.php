                            ...
                            <div class="mt-8 relative">
                                ...
                                <div x-show="selectedNetwork === 'mtn'" class="space-y-4">
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-yellow-400 text-[10px] font-semibold text-yellow-900">1</span>
                                        <p class="text-sm text-slate-700">Dial <span class="font-semibold">*170#</span></p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-yellow-400 text-[10px] font-semibold text-yellow-900">2</span>
                                        <p class="text-sm text-slate-700">Select <span class="font-semibold">MoMoPay & Pay Bill</span> (2) > <span class="font-semibold">MoMoPay</span> (1)</p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-yellow-400 text-[10px] font-semibold text-yellow-900">3</span>
                                        <p class="text-sm text-slate-700">Enter Merchant ID: <span class="font-semibold text-yellow-700">{{ $settings['merchant_number'] }}</span></p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-yellow-400 text-[10px] font-semibold text-yellow-900">4</span>
                                ...
                                <div x-show="selectedNetwork === 'telecel'" x-cloak class="space-y-4">
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-red-600 text-[10px] font-semibold text-white">1</span>
                                        <p class="text-sm text-slate-700">Dial <span class="font-semibold">*110#</span></p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-red-600 text-[10px] font-semibold text-white">2</span>
                                        <p class="text-sm text-slate-700">Select <span class="font-semibold">Pay Bill</span> > <span class="font-semibold">Others</span></p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-red-600 text-[10px] font-semibold text-white">3</span>
                                        <p class="text-sm text-slate-700">Enter Merchant Code: <span class="font-semibold text-red-700">{{ $settings['merchant_number'] }}</span></p>
                                    </div>
                                </div>

                                <div x-show="selectedNetwork === 'at'" x-cloak class="space-y-4">
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-blue-600 text-[10px] font-semibold text-white">1</span>
                                        <p class="text-sm text-slate-700">Dial <span class="font-semibold">*110#</span></p>
                                    </div>
                                    <div class="flex gap-4 group">
                                        <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-blue-600 text-[10px] font-semibold text-white">2</span>
                                        <p class="text-sm text-slate-700">Select <span class="font-semibold">Pay Bill</span> and enter code: <span class="font-semibold text-blue-700">{{ $settings['merchant_number'] }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sticky top-10">
                        <div class="overflow-hidden rounded-[2.5rem] bg-[#16136a] p-1 shadow-2xl shadow-[#16136a]/30">
                            <div class="rounded-[2.3rem] bg-gradient-to-br from-[#1c198a] to-[#14125a] px-8 py-8">
                                <div class="space-y-8">
                                    <div>
                                        <p class="text-[11px] font-semibold uppercase tracking-[0.3em] text-white/40">Merchant Name</p>
            ...
            <div class="mx-auto mt-12 max-w-2xl">
                <section class="overflow-hidden rounded-[3rem] border border-[#16136a]/10 bg-white shadow-2xl shadow-[#16136a]/10">
                    ...
                    <form action="{{ route('admin.personal-dues.manual.store', $due) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                        ...
                        <button type="submit" class="w-full rounded-[2rem] bg-[#16136a] px-10 py-5 text-sm font-semibold uppercase tracking-[0.25em] text-white shadow-2xl transition-all hover:bg-[#1c198a] active:scale-95">
