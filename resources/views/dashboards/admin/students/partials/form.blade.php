        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-user class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-envelope class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-phone class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-at-symbol class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
    ...
    <section class="space-y-6">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-hashtag class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    <x-heroicon-o-building-office-2 class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    <x-heroicon-o-calendar class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
    ...
    <section class="space-y-6">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="space-y-2" x-data="{
                ...
                <div class="group relative">
                    <x-heroicon-o-shield-check class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
            ...
            <div class="space-y-2">
                ...
                <div class="group relative">
                    <x-heroicon-o-lock-closed class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#16136a] size-5" />
